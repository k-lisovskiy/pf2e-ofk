...
resource: "pf2e://spells/rank-3/mad-monkeys"
...
**Failure** For 1 round, the creature must succeed at a flat check (DC 5) whenever it attempts a manipulate action. If it fails this check, the creature loses that action.
...
[2] Source: `packs/pf2e/spells/spells/rank-3/mad-monkeys.json` (pf2e system data)
