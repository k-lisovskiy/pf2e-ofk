...
description: "You call upon the lost and forgotten, assailing your foes' minds with the memories of those who died with a grievance toward them."
resource: "pf2e://spells/focus/remember-the-lost"
tags: ["cleric", "concentrate", "manipulate", "mental"]
...
duration: ""
cost: ""
publication: "Pathfinder Lost Omens Divine Mysteries"
---
...
If you know the names of anyone murdered or grievously wronged by an enemy in the area, you can chant those victims' names when you Cast the Spell to improve the clarity of the visions, increasing the damage to the corresponding enemy from 6d6 to (2*(level - 1))d10 mental]|shortLabel; you can do so for multiple enemies if you know specific victims of each enemy. The visions are personal to each foe in the area, and you can't use this spell to discern a murderer by guessing a name. A creature that truly knows no one who died with any sort of grievance to that creature is immune to this effect.
...
[2] Source: `packs/pf2e/spells/focus/remember-the-lost.json` (pf2e system data)
