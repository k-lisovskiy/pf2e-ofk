...
resource: "pf2e://spells/focus/shambling-horror"
tags: ["attack", "concentrate", "evil", "manipulate"]
...
- **Targets**: 1 corpse of a Gargantuan or smaller creature that has a level no greater than your level -4 and has died since the last sunrise
- **Duration**: 10 minutes
- **Traits**: attack, concentrate, evil, focus, manipulate
...
[2] Source: `packs/pf2e/spells/focus/shambling-horror.json` (pf2e system data)
