...
description: "Drawing upon the deepest wells of magic in an elemental plane, you transform into a spectacular elemental."
resource: "pf2e://spells/rank-10/element-embodied"
tags: ["concentrate", "manipulate", "polymorph"]
...
- **Melee** 1 action gust (reach 25 feet), **Damage** 3d12+11 bludgeoning plus Push 10 feet;
- **Ranged** 1 action lightning lash (range increment 80 feet), **Damage** 3d12+4 electricity.
...
- **Melee** 1 action fist (reach 25 feet), **Damage** 3d12+15 bludgeoning;
- **Ranged** 1 action rock (range increment 40 feet), **Damage** 4d8+6 bludgeoning.
...
- **Melee** 1 action tendril (reach 25 feet), **Damage** 3d10+12 fire plus 2d6 persistent fire;
- **Ranged** 1 action fire mote (range increment 60 feet), **Damage** 4d8+6 fire.
...
- **Melee** 1 action blade (reach 25 feet, versatile slashing), **Damage** 3d12+15 piercing;
- **Ranged** 1 action metal shard (range increment 40 feet, versatile slashing), **Damage** 4d8+6 piercing.
...
- **Melee** 1 action wave (reach 25 feet), **Damage** 3d12+18 bludgeoning plus Push or Pull 10 feet;
- **Ranged** 1 action water spout (range increment 60 feet), **Damage** 4d8+6 bludgeoning.
...
- **Melee** 1 action branch (reach 25 feet), **Damage** 3d10+18 piercing;
- **Ranged** 1 action seed (range increment 40 feet), **Damage** 4d8+6 bludgeoning.

# Citations

[1] Pathfinder Rage of Elements
[2] Source: `packs/pf2e/spells/spells/rank-10/element-embodied.json` (pf2e system data)
