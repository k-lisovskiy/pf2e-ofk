...
description: "Few incantations are as renowned as the power to create worlds."
resource: "pf2e://spells/rituals/create-demiplane"
...
primary_check: "Arcana (mythic), Nature (mythic), Occultism (mythic), or Religion (mythic)"
secondary_casters: "3"
secondary_checks: "Arcana, Nature, Occultism, Religion (whichever three aren't used for the primary check)"
...
[2] Source: `packs/pf2e/spells/rituals/create-demiplane.json` (pf2e system data)
