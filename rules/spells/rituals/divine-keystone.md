---
type: Ritual
title: "Divine Keystone"
description: "You magically remove and consecrate the cornerstone of a building or ruin in the center of a settlement before returning the stone to its structure to spread its divine protection into the settleme..."
resource: "pf2e://spells/rituals/divine-keystone"
tags: ["consecration", "holy"]
...
defense: ""
duration: "1 week"
cost: "holy water, powdered silver, and purified chalk worth 200 gp"
primary_check: "Arcana (master) or Religion (expert)"
secondary_casters: "1"
secondary_checks: "Architecture Lore, Crafting, or Engineering Lore"
...
- **Rank**: 4
- **Cast**: 4 days
- **Primary Check**: Arcana (master) or Religion (expert)
- **Secondary Casters**: 1
- **Secondary Checks**: Architecture Lore, Crafting, or Engineering Lore
- **Cost**: holy water, powdered silver, and purified chalk worth 200 gp
- **Area**: 100-foot emanation
- **Duration**: 1 week
...
[1] Pathfinder Adventure Path: Hellbreakers
[2] Source: `packs/pf2e/spells/rituals/divine-keystone.json` (pf2e system data)
