...
description: "You call upon the primal presence of the Fierani Forest and the elven legacy of Kyonin in an attempt to purify a portion of the blighted realm of Tanglebriar."
resource: "pf2e://spells/rituals/purify-tanglebriar"
tags: ["consecration"]
...
defense: ""
duration: "see text"
cost: "rare incense and offerings worth a total value of 2,000 gp"
primary_check: "Nature or Religion"
secondary_casters: "3"
secondary_checks: "Arcana, Nature, Religion, Survival, or Tanglebriar Lore"
publication: "Pathfinder #212: A Voice in the Blight"
---
...
- **Rank**: 9
- **Cast**: 8 hours
- **Primary Check**: Nature or Religion
- **Secondary Casters**: 3
- **Secondary Checks**: Arcana, Nature, Religion, Survival, or Tanglebriar Lore
- **Cost**: rare incense and offerings worth a total value of 2,000 gp
- **Range**: 1-mile-radius circle centered on you
- **Duration**: see text
- **Traits**: consecration
...
**Critical Failure** The region is unaffected, and the magic itself becomes corrupted and backfires on the casters. Each caster takes 20d6 void damage (fortitude save (DC 38) save) as the purification energies sap away life itself. For 1 month, any attempt by that same primary caster to perform purify Tanglebriar increases its DCs by 5.

# Citations

[1] Pathfinder #212: A Voice in the Blight
[2] Source: `packs/pf2e/spells/rituals/purify-tanglebriar.json` (pf2e system data)
