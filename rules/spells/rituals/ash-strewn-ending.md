...
duration: "1 week"
cost: ""
primary_check: "Religion (mythic) or Performance (mythic)"
secondary_casters: "3"
secondary_checks: "Crafting, Pharasma Lore, or Survival"
...
- **Rank**: 4
- **Cast**: 8 hours
- **Primary Check**: Religion (mythic) or Performance (mythic)
- **Secondary Casters**: 3
- **Secondary Checks**: Crafting, Pharasma Lore, or Survival
- **Range**: 10 feet
- **Area**: 1000-foot burst
- **Duration**: 1 week
- **Traits**: death, mythic
...
[2] Source: `packs/pf2e/spells/rituals/ash-strewn-ending.json` (pf2e system data)
