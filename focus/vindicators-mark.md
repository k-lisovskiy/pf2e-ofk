...
description: "You launch a magical dart at your hunted prey, which marks them with a nimbus only you can detect."
resource: "pf2e://focus/vindicators-mark"
tags: ["attack", "manipulate", "sanctified"]
...
You can Dismiss the spell on your turn if your last action dealt damage to the target with a weapon or unarmed attack, instantly dealing an additional (ceil(rank/2)+1)d6 spirit damage to it.
...
[2] Source: `packs/pf2e/spells/focus/vindicators-mark.json` (pf2e system data)
