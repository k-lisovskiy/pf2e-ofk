...
type: Focus Spell
title: "Tempest Form"
description: "Your body becomes fluid to better suit your surroundings."
resource: "pf2e://focus/tempest-form"
tags: ["concentrate", "manipulate", "oracle", "polymorph"]
...
- **Water** You gain a swim Speed of 20 feet and become invisible while you are in the water. You can electrically charge yourself by taking a single action, which has the manipulate trait. If you do, you are no longer invisible in the water due to electricity indicating your location, but any creature that makes a melee attack against you takes (1d6+max(0,floor(rank/2) -3)) electricity damage.
...
[2] Source: `packs/pf2e/spells/focus/tempest-form.json` (pf2e system data)
