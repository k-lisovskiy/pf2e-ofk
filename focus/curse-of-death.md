...
description: "Your patron wraps a hand around your target's heart."
resource: "pf2e://focus/curse-of-death"
tags: ["concentrate", "curse", "death", "hex", "manipulate", "void", "witch"]
...
**Stage 1** (max(4,(rank)-1))d6 void damage and Fatigued (1 round)

**Stage 2** (max(8,rank+3))d6 void damage and fatigued (1 round)

**Stage 3** (max(12,rank+7))d6 void damage and fatigued (1 round)
...
[2] Source: `packs/pf2e/spells/focus/curse-of-death.json` (pf2e system data)
