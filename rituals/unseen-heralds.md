...
description: "Although this spell has spread throughout the Inner Sea, it likely came first from Nex, where it is used to raise alarms or notify the populace of new policies."
resource: "pf2e://rituals/unseen-heralds"
tags: ["attack", "auditory", "illusion", "visual"]
...
secondary_casters: "2"
secondary_checks: "Arcana or Occultism (whichever isn't used for the primary check), Diplomacy"
...
- **Area**: 100-foot square
- **Duration**: 1 year
- **Traits**: attack, auditory, illusion, visual
...
[2] Source: `packs/pf2e/spells/rituals/unseen-heralds.json` (pf2e system data)
