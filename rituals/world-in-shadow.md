...
description: "This ritual must be cast at night, at which point darkness becomes everlasting."
resource: "pf2e://rituals/world-in-shadow"
tags: ["darkness", "mythic"]
...
duration: "5 days"
cost: ""
primary_check: "Arcana (mythic), Nature (mythic), or Occultism (mythic), Religion (mythic)"
secondary_casters: "3"
secondary_checks: "Arcana, Nature, Occultism, Religion (cannot be the same skill as for the primary check)"
...
- **Rank**: 5
- **Cast**: 8 hours
- **Primary Check**: Arcana (mythic), Nature (mythic), or Occultism (mythic), Religion (mythic)
- **Secondary Casters**: 3
...
[2] Source: `packs/pf2e/spells/rituals/world-in-shadow.json` (pf2e system data)
