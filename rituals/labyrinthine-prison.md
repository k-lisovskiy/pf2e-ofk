...
resource: "pf2e://rituals/labyrinthine-prison"
...
defense: ""
duration: "varies"
cost: "fine paper and ink worth a total value of the target's level × 25 gp"
primary_check: "Deception (expert), Maze Lore (trained), or Religion (expert)"
secondary_casters: "2"
secondary_checks: "Art Lore (trained), Crafting (trained), or Thievery (trained)"
publication: "Pathfinder #217: Death Sails a Wine-Dark Sea"
---
...
- **Rank**: 3
- **Cast**: 1 day
- **Primary Check**: Deception (expert), Maze Lore (trained), or Religion (expert)
- **Secondary Casters**: 2
- **Secondary Checks**: Art Lore (trained), Crafting (trained), or Thievery (trained)
- **Cost**: fine paper and ink worth a total value of the target's level × 25 gp
- **Range**: 60 feet
- **Targets**: 1 creature of up to 8th level
- **Duration**: varies
...
[1] Pathfinder #217: Death Sails a Wine-Dark Sea
[2] Source: `packs/pf2e/spells/rituals/labyrinthine-prison.json` (pf2e system data)
